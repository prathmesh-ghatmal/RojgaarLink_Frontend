...
const CHATS = [
  {
    ...
    avatar: "A",
    lastMessage: "The working hours are from 8 AM to 5 PM with a 1-hour lunch break.",
    timestamp: "10:40 AM",
    unread: 0,
  },
  {
  ...
  },
  {
    ...
    avatar: "M",
    lastMessage: "Your application has been accepted. Please come for an interview.",
  ...
  },
  {
    ...
    avatar: "G",
    lastMessage: "Thank you for your interest. We'll get back to you soon.",
              ...
              {selectedChat ? (
                <>
                  ...
                  <div className="p-3 border-b flex items-center justify-between">
                    ...
                    <div>
                      <Link href={`/worker/chat/${selectedChat}`}>
                ...
                <div className="flex items-center justify-center h-full">
                  <div className="text-center p-4">
                    ...
                    <Button variant="outline" onClick={() => setSelectedChat("chat1")}>
